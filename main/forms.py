...
class ReviewForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'text': forms.Textarea(attrs={'rows': 4, 'placeholder': 'Your feedback...'}),
...
class ClientRegistrationForm(UserCreationForm):
    ...
    responsible_person = forms.CharField(max_length=100, required=False, label='Responsible person')
    age = forms.IntegerField(required=False, min_value=18, max_value=120, label='Age (optional)')
